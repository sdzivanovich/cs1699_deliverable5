...
-- helper function that determines if a list is sorted.
...
prop_sortedListIsSorted :: [Int] -> Bool
prop_sortedListIsSorted xs = isSorted . My.sort $ xs

-- sorting a sorted list should not change the list.
prop_sortingASortedListDoesNothing :: [Int] -> Bool
prop_sortingASortedListDoesNothing xs =
    let sorted = My.sort xs
    in  My.sort sorted == sorted

-- sorting a list should not add any elements.
prop_sortedListContainsNoNewElements :: [Int] -> Bool
prop_sortedListContainsNoNewElements xs =
    let sorted = My.sort xs
    in  all (`My.elem` xs) sorted

-- a sorted list should contain all of the original elements.
prop_sortedListContainsOriginalElements :: [Int] -> Bool
prop_sortedListContainsOriginalElements xs =
    let sorted = My.sort xs
    in  all (`My.elem` sorted) xs
...
main = do
    ...
    labeledCheck (NamedProp "prop_sortedListIsSorted" prop_sortedListIsSorted)
    labeledCheck (NamedProp "prop_sortingASortedListDoesNothing" prop_sortingASortedListDoesNothing)
    labeledCheck (NamedProp "prop_sortedListContainsNoNewElements" prop_sortedListContainsNoNewElements)
    labeledCheck (NamedProp "prop_sortedListContainsOriginalElements" prop_sortedListContainsOriginalElements)
